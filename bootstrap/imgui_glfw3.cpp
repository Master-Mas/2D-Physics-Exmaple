...
// This is the main rendering function that you have to implement and provide to ImGui (via setting m_up 'RenderDrawListsFn' in the ImGuiIO structure)
...
bool ImGui_Init(GLFWwindow* window, bool install_callbacks) {
    ...
    ImGuiIO& io = ImGui::GetIO();
    io.KeyMap[ImGuiKey_Tab] = GLFW_KEY_TAB;                         // Keyboard mapping. ImGui will use those m_indices to peek into the io.KeyDown[] array.
