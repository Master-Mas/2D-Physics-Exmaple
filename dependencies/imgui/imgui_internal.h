...
struct ImGuiContext
{
    ...
    ImGuiContext()
    {
        ...
        OverlayDrawList._OwnerName = "##Overlay"; // Give it a m_name for debugging
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImVec2                  PosFloat;
    ImVec2                  Pos;                                // Position rounded-m_up to nearest pixel
...
namespace ImGui
{
    ...
    IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos, float m_radius);
